class OrderDetailsController < ApplicationController
  ...
  def index
    @order_details = OrderDetail.search(params[:search]).paginate(:page => params[:page], :per_page => 10)
  end
  ...
  def destroy
    begin
      ...
      redirect_to order_detail_path, :flash => { :error => "Can not remove this order details" }
    end
  end
  ...
  private
    ...
    def order_detail_params
      params.require(:order_detail).permit(:number, :product_id, :order_id)
    end
end
