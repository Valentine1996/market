...
class MerchantsControllerTest < ActionController::TestCase
  ...
  test "should create merchant" do
    assert_difference('Merchant.count') do
      post :create, merchant: { address_id: @merchant.address_id, discount: @merchant.discount, name: @merchant.name }
    end
  ...
  test "should update merchant" do
    patch :update, id: @merchant, merchant: { address_id: @merchant.address_id, discount: @merchant.discount, name: @merchant.name }
    assert_redirected_to merchant_path(assigns(:merchant))
  end
